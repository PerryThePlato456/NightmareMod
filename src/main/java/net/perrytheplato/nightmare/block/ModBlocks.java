...
public static final Block MAGNETITE_BLOCK = registerBlock("magnetite_block", new Block(AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(NightmareMod.MOD_ID, "magnetite_block.json"))).strength(4f).requiresTool().sounds(BlockSoundGroup.AMETHYST_BLOCK)));
    ...
    public static final Block KING_MUMMY_HEART = registerBlock("king_mummy_heart", new Block(AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(NightmareMod.MOD_ID, "king_mummy_heart"))).strength(2f).requiresTool().sounds(BlockSoundGroup.AMETHYST_BLOCK)));
    ...
    public static void registerModBlocks() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.NATURAL).register(entries -> {
            ...
            entries.add(ModBlocks.KING_MUMMY_HEART);
        });
    }
}
