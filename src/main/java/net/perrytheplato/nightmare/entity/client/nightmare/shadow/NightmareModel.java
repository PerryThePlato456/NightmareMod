...
public class NightmareModel extends EntityModel<NightmareRenderState> {
    public static final EntityModelLayer NIGHTMARE = new EntityModelLayer(Identifier.of(NightmareMod.MOD_ID, "nightmare"), "main");
    ...
    public NightmareModel(ModelPart root) {
        ...
        this.walkingAnimation = NightmareAnimations.WALK.createAnimation(root);
        this.idlingAnimation = NightmareAnimations.IDLE.createAnimation(root);
        this.attackAnimation = NightmareAnimations.ATTACK.createAnimation(root);
    ...
    @Override
    public void setAngles(NightmareRenderState state) {
