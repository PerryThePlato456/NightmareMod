...
public class MummyModel extends EntityModel<MummyRenderState> {
    public static final EntityModelLayer MUMMY = new EntityModelLayer(Identifier.of(NightmareMod.MOD_ID, "mummy"), "main");
    ...
    public MummyModel(ModelPart root) {
        ...
        this.walkingAnimation = MummyAnimations.WALK.createAnimation(root);
        this.idlingAnimation = MummyAnimations.IDLE.createAnimation(root);
        this.attackAnimation = MummyAnimations.ATTACK.createAnimation(root);
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData left_arm = modelPartData.addChild("left_arm", ModelPartBuilder.create().uv(24, 16).cuboid(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(5.0F, 2.0F, 0.0F));
    ...
    @Override
    public void setAngles(MummyRenderState state) {
