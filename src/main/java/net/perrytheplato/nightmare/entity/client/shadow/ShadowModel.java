package net.perrytheplato.nightmare.entity.client.shadow;
...
public class ShadowModel extends EntityModel<ShadowRenderState> {
    public static final EntityModelLayer SHADOW = new EntityModelLayer(Identifier.of(NightmareMod.MOD_ID, "shadow"), "main");
    ...
    public ShadowModel(ModelPart root) {
        ...
        this.walkingAnimation = ShadowAnimations.WALK.createAnimation(root);
        this.idlingAnimation = ShadowAnimations.IDLE.createAnimation(root);
        this.attackAnimation = ShadowAnimations.ATTACK.createAnimation(root);
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData left_arm = modelPartData.addChild("left_arm", ModelPartBuilder.create().uv(24, 29).cuboid(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(5.0F, 2.0F, 0.0F));



        ModelPartData right_arm = modelPartData.addChild("right_arm", ModelPartBuilder.create().uv(0, 32).cuboid(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(-5.0F, 2.0F, 0.0F));
        return TexturedModelData.of(modelData, 64, 64);
    }
    @Override
    public void setAngles(ShadowRenderState state) {
