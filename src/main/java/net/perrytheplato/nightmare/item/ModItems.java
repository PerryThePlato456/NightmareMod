...
public class ModItems {
    ...
    public static final Item KING_MUMMY_HEART_FRAGMENT = registerItem("king_mummy_heart_fragment", new Item(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(NightmareMod.MOD_ID,"king_mummy_heart_fragment")))));
    ...
    public static void registerModItems() {
        NightmareMod.LOGGER.info("Registering Mod Items for " + NightmareMod.MOD_ID);
            ...
            entries.add(KING_MUMMY_HEART_FRAGMENT);
